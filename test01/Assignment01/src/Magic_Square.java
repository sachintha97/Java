...
public class Magic_Square {
    ...
    public static boolean isMagic(int[][] square) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            arraylist[7] = sum_diagonal;
        }

        boolean isMagic = isAllSame(arraylist);
        return isMagic;
    ...
    public static void main(String[] args) {
        boolean continuethewholeprogamme=true;
        while (continuethewholeprogamme) {
            ...
            if (choiceofuser == 1) {
                ...
                continuethewholeprogamme=false;
            }else{
