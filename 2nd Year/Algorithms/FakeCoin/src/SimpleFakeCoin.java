/**
 * Problem -
 * You have been given 100 ancient and very valuable coins that all look identical
 * but one is fake.fake one weight more or less than the rest.
...
public class SimpleFakeCoin {
    ...
    private Coin[] initializeCoins(int numCoins){
        Coin[] coins = new Coin[numCoins]; // int numCoins - number of coin
