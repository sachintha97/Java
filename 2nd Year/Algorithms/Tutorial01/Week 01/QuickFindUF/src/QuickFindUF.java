...
import java.io.*;  // For reading the input data within an IDE
import java.util.Scanner; // For reading the input data within an IDE
...
public class QuickFindUF {
    ...
    public QuickFindUF(int N) {
	    count = N; // N the number of objects
	    id = new int[N];
	    for(int i = 0; i <= N-1; i++)
	        id[i] = i;
    }
